...
export const MOCK_TEMPLATES: (ReportTemplateApi & { fields: FieldApi[] })[] = [
  {
    id: 1,
...
export const MOCK_TRAMITES: TramiteApi[] = [
  { id: 1, servicio_id: 1, servicio_nombre: 'Reporte de Ventas', categoria: 'Ventas', usuario_id: 1, usuario_nombre: 'Dayanna Solano', estado: 'completado', created_at: '2024-03-01 10:30:00' },
  { id: 2, servicio_id: 2, servicio_nombre: 'Reporte de Gastos', categoria: 'Finanzas', usuario_id: 2, usuario_nombre: 'Kenny Melendez', estado: 'pendiente', created_at: '2024-03-02 14:15:00' },
  { id: 3, servicio_id: 1, servicio_nombre: 'Reporte de Ventas', categoria: 'Ventas', usuario_id: 1, usuario_nombre: 'Dayanna Solano', estado: 'en_proceso', created_at: '2024-03-03 09:00:00' },
  ...
  { id: 5, servicio_id: 2, servicio_nombre: 'Reporte de Gastos', categoria: 'Finanzas', usuario_id: 2, usuario_nombre: 'Kenny Melendez', estado: 'rechazado', created_at: '2024-03-05 11:20:00' }
];

export const MOCK_CAMPOS_TRAMITES: CampoTramiteApi[] = [
