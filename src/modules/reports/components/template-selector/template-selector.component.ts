          ...
          <div class="modal-content">
            @if (loading) {
              ...
              <div class="empty-state">
                ...
                <span>Contacte al administrador para crear plantillas de reportes</span>
              </div>
            } @else {
              <p class="description">
                Seleccione la plantilla que desea usar para crear su reporte:
              </p>
...
export class TemplateSelectorComponent implements OnInit {
  ...
  @Output() select = new EventEmitter<ReportTemplate>();
